...
public class ServiceRequestController {
    ...
    public ServiceRequestController(ServiceRequestService serviceRequestService, ObservationService observationService, CustomUserDetailsService customUserDetailsService) {
    ...
    @PostMapping
    @PreAuthorize("hasAnyRole('ADMIN', 'TECHNICIAN', 'RECEPTIONIST') and (@securityService.canAccessEncounter(#request.encounterId) or @securityService.canAccessPatient(#request.patientId))")
    ...
    @PutMapping("/{id:[0-9]+}")
    @PreAuthorize("hasAnyRole('ADMIN', 'TECHNICIAN', 'RECEPTIONIST') and @securityService.canAccessServiceRequest(#id)")
    ...
    @GetMapping("/{id:[0-9]+}")
    @PreAuthorize("hasAnyRole('ADMIN', 'RECEPTIONIST', 'DOCTOR', 'PATHOLOGIST', 'TECHNICIAN') and @securityService.canAccessServiceRequest(#id)")
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'RECEPTIONIST', 'DOCTOR', 'PATHOLOGIST', 'TECHNICIAN') and @securityService.canAccessPatient(#patientId)")
    ...
    @GetMapping("/search")
    @PreAuthorize("hasAnyRole('ADMIN', 'TECHNICIAN', 'RECEPTIONIST', 'DOCTOR', 'PATHOLOGIST') and #orgId != null and @securityService.isCurrentUserInOrganizationStrict(#orgId)")
